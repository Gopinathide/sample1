            ...
            <div class="row">
                ...
                <table class="table table-bordered text-center" style="width:1000px;">
                  ...
                  <tbody>
                      <?php
                              ...
                              global $con;
                              $cart_query="Select * from `categories`";
                              ...
                              if($result_count>0)
                              {
                                    ...
                                    ?>
                                        ...
                                        $get_ip_add = getIPAddress();
                                            ...
                                            <input type="submit" value="Remove Category" name="remove_cart" class="bg-info px-3 py-2 border-0 mx-3">
                                            </td>
                                            </tr>
              ...
              function remove_cart_item()
              {
                 ...
                 foreach($_POST['removeitem'] as $remove_id)
                 {
                    ...
                    $select="Delete from `products` where category_id=$remove_id";
                    $run=mysqli_query($con,$select);
                    if($run_delete)
                    {

                        echo"<script>alert('Category have been removed successfuly')</script>";
